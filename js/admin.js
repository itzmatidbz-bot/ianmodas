...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function generateRealisticUsers() {
        const empresasReales = [
            { 
                nombre: 'María', apellido: 'González', empresa: 'Boutique Elegancia', 
                email: 'contacto@boutiqueelegancia.com', rut: '12345678-9', celular: '099123456',
                direccion: 'Rivera 1234', departamento: 'Montevideo', agencia: 'DAC', dias: 5 
            },
            { 
                nombre: 'Carlos', apellido: 'Rodríguez', empresa: 'Moda Total Distribuidora', 
                email: 'ventas@modatotal.com.uy', rut: '23456789-0', celular: '098987654',
                direccion: '18 de Julio 2000', departamento: 'Montevideo', agencia: 'UES', dias: 12 
            },
            { 
                nombre: 'Ana', apellido: 'Martínez', empresa: 'Comercial Vestimenta', 
                email: 'info@comercialvestimenta.com', rut: '34567890-1', celular: '097765432',
                direccion: 'Av. Italia 3000', departamento: 'Canelones', agencia: 'Mirtrans', dias: 8 
            },
            { 
                nombre: 'Luis', apellido: 'Fernández', empresa: 'Almacén de Modas', 
                email: 'pedidos@almacenmodas.com.uy', rut: '45678901-2', celular: '096543210',
                direccion: 'Sarandi 500', departamento: 'Maldonado', agencia: 'Nordeste', dias: 15 
            },
            { 
                nombre: 'Patricia', apellido: 'Silva', empresa: 'Fashion Center', 
                email: 'mayorista@fashioncenter.com', rut: '56789012-3', celular: '095432109',
                direccion: 'Bulevar Artigas 1500', departamento: 'Montevideo', agencia: 'DAC', dias: 3 
            }
        ];
    ...
    function renderProductsTable(products) {
        ...
        if (products.length === 0) {
            DOMElements.productsTableBody.innerHTML = '<tr><td colspan="6">No hay productos</td></tr>';
            return;
        }
        ...
        DOMElements.productsTableBody.innerHTML = products.map(product => {
            ...
            const tipoPrenda = product.tipo_prenda_nombre || product.tipo_prenda || '';
    ...
    function loadFallbackCategories() {
        ...
        const fallbackCategorias = [
            ...
            { id: 11, nombre: 'Accesorios', descripcion: 'Complementos y accesorios' },
    ...
    function loadFallbackTiposTela() {
        const fallbackTiposTela = [
            { id: 1, nombre: 'Algodón', descripcion: 'Fibra natural suave y transpirable' },
