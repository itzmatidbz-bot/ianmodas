document.addEventListener('DOMContentLoaded', async () => {
    ...
    // --- FUNCIONES PARA SISTEMA DE CATEGORIZACIÓN AVANZADA CON 3FN ---
    async function loadCategoriesData() {
        try {
            console.log('🏷️ Cargando sistema de categorización avanzada con soporte 3FN...');
            
            // NUEVO: Intentar cargar con funciones 3FN primero
            await tryLoad3FNSystem();
